...
#define      Relay_dcha        D6   // (D4) 
#define      Relay_izda        D5   // (D5) 
...
////////////////////////////////////////////////////
    ...
    //
    client.println("D1 Output relay");
    client.println("D2 Satatus LED");
    client.println("D3 Button");
    client.println("D4 Relay_dcha");
    client.println("D5 Relay_izda");
    client.println("D6 Salida Analogica");
    ...
    if ( (TimeOk == false) and (Mode == 2) ) { 
      ...
      client.println("<br>");
      client.print(" Prog. Miel : Run/Stop:"); if (Run) {client.print("Run");} else {client.print("Stop");}client.println("<br>");
